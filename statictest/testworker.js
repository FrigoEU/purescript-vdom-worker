  ...
  var main = function __do() {
      ...
      var dispatch = function (action) {
          return function __do() {
              ...
              return WebWorker.postMessageC(VirtualDOM.encodeJsonSerializedVPatches)(Test_Main.patchesChannel)(serializedPatches)();
          };
      };
      var chs = WebWorker.registerChannel(VirtualDOM_Worker.decodeJsonWEvent)(Data_StrMap.empty)(Test_Main.wEventsChannel)(v.handler);
      WebWorker.onmessageC(chs)();
