  ...
  var registerWEventHandler = function (dictEncodeJson) {
      return function (dictDecodeJson) {
          return function (wes) {
              return function (v) {
                  return function (f) {
                      return Data_StrMap.insert(v.value0.tag)(function ($36) {
                          return Prelude.map(Control_Monad_Eff.functorEff)(Data_Argonaut_Encode.encodeJson(dictEncodeJson))(f($36));
                      })(wes);
                  };
              };
          };
                                      ...
                                      return Prelude.bind(Data_Maybe.bindMaybe)(Data_StrMap.lookup(v5)(weh))(function (v6) {
                                          return Prelude["return"](Data_Maybe.applicativeMaybe)(function (ev) {
                                              return function __do() {
                                                  var json = v6(ev)();
                                                  return WebWorker.postMessageToWorker(ww)(Data_Foreign.toForeign(Prelude.show(showMessage)({
                                                      id: v3, 
                                                      data: json
                                                  })))();
                                              };
  ...
  var main = Test_Unit.runTest(Test_Unit.test("make worker, click button, check that text = screenX + screenY")((function () {
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(VirtualDOM.appendToBody(node)))(function () {
          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(WebWorker.mkWorker("testworker.js")))(function (v) {
              var mdh = VirtualDOM_Worker.makeDOMHandlersForWEvents(v)(allWEvents);
              var handleMessageFromWorker = function (v1) {
                  var serPs = Data_Either.either(Prelude["const"]([  ]))(VirtualDOM.fromString)(Data_Foreign_Class.read(Data_Foreign_Class.stringIsForeign)(v1.data));
                  return VirtualDOM.applyPatch(node)(serPs)(mdh);
              };
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(WebWorker.onmessageFromWorker(v)(handleMessageFromWorker)))(function () {
